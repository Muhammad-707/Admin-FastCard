...
export default function LogIn() {
  ...
  const validationSchema = Yup.object({
    name: Yup.string().min(2, `${t("text167")}`).required(`${t("text170")}`),
    email: Yup.string().email(`${t("text168")}`).required(`${t("text170")}`),
    password: Yup.string().min(6, `${t("text169")}`).required(`${t("text170")}`),
  });
      ...
      <div className="grid w-full grid-cols-1 lg:grid-cols-2">
        <div className="relative hidden flex-col items-center justify-center bg-[#1e2640] p-12 lg:flex select-none">
          ...
          <div className="relative z-10 text-center">
            <h1 className="text-3xl font-medium tracking-wide text-white/90">{t("text1")}</h1>
            <div>
        ...
        <div className="flex items-center justify-center p-8 sm:p-12 lg:p-16">
          <div className="w-full max-w-md">
            <h2 className="mb-6 text-3xl font-bold tracking-tight text-slate-900">{t("text2")}</h2>
            <form onSubmit={formik.handleSubmit} className="space-y-4">
              <div>
                <input id="name" name="name" type="text" placeholder={t("text5")} value={formik.values.name} onChange={formik.handleChange} onBlur={formik.handleBlur}
              ...
              <div>
                <input id="email" name="email" type="email" placeholder={t("text3")} value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur}
              ...
              <div>
                <div className="relative">
                  <input id="password" name="password" type={showPassword ? "text" : "password"} placeholder={t("text4")} value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur}
              ...
              <div className="text-center">
                <a href="#forgot" className="text-sm font-semibold text-blue-600 hover:text-blue-700">{t("text6")}</a>
              </div>
